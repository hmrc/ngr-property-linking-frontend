...
case class File(
                 recipientOrSender: Option[String], //SRN
                 name: String,
                 location: Option[String], //OBJECT STORE 
                 checksum: Checksum,
                 size: Int,
                 properties: List[Property] //THIS IS THE METADATA
               )
...
case class FileTransferNotification(
                                     informationType: String, //THIS IS WHO WE SEND TOO MANAGED BY SDES
                                     file: File,
                                     audit: Audit
                                   )
