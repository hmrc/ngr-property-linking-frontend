...
trait AppConfig {
  ...
  val customDate: Option[String] // TODO remove this after 1st April 2026, as it is only used for testing purposes
}
...
class FrontendAppConfig @Inject()(config: Configuration, servicesConfig: ServicesConfig) extends AppConfig {
  ...
  override val customDate: Option[String] = config.getOptional("custom-date")
  def getString(key: String): String =
