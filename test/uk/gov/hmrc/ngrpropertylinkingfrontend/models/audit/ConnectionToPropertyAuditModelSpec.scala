...
import uk.gov.hmrc.ngrpropertylinkingfrontend.models.forms.{ConnectionToPropertyForm, CurrentRatepayerForm}

class ConnectionToPropertyAuditModelSpec extends TestSupport with AnyWordSpecLike {

  "Current Ratepayer Audit Model" should {

    val exampleModel =
      ConnectionToPropertyAuditModel(
        "123456",
        ConnectionToPropertyForm.stringToPropertyForm("Owner"),
