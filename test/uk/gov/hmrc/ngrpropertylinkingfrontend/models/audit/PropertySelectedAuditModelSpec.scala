...
import uk.gov.hmrc.ngrpropertylinkingfrontend.models.forms.{ManualPropertySearchForm, PropertySelectedForm}

class PropertySelectedAuditModelSpec extends TestSupport with AnyWordSpecLike {

  "Find A Property Audit Model" should {

    val exampleModel =
      PropertySelectedAuditModel(
        "123456",
        PropertySelectedForm("Yes"),
