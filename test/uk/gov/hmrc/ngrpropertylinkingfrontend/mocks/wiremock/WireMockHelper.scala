...
package uk.gov.hmrc.ngrpropertylinkingfrontend.mocks.wiremock
...
import uk.gov.hmrc.ngrpropertylinkingfrontend.mocks.wiremock.WireMockHelper.{MappingBuilderExt, ResponseDefinitionBuilderExt, wireMockPort}
...
object WireMockHelper {
  ...
  implicit class MappingBuilderExt(builder: MappingBuilder) {
