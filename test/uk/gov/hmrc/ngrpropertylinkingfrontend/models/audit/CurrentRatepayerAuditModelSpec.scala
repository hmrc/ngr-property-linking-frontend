...
import uk.gov.hmrc.ngrpropertylinkingfrontend.models.forms.{CurrentRatepayerForm, PropertySelectedForm}

class CurrentRatepayerAuditModelSpec extends TestSupport with AnyWordSpecLike {

  "Current Ratepayer Audit Model" should {

    val exampleModel =
      CurrentRatepayerAuditModel(
        "123456",
        CurrentRatepayerForm("Before", None),
