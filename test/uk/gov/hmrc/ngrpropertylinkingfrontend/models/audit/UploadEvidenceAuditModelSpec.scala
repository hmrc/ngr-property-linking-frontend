...
import uk.gov.hmrc.ngrpropertylinkingfrontend.models.forms.{PropertySelectedForm, UploadEvidenceForm}

class UploadEvidenceAuditModelSpec extends TestSupport with AnyWordSpecLike {

  "Upload Evidence Audit Model" should {

    val exampleModel =
      UploadEvidenceAuditModel(
        "123456",
        UploadEvidenceForm("ServiceStatement"),
