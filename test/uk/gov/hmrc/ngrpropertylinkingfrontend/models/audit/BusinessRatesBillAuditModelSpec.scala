...
import uk.gov.hmrc.ngrpropertylinkingfrontend.models.forms.{BusinessRatesBillForm, FindAPropertyForm, PropertySelectedForm}

class BusinessRatesBillAuditModelSpec extends TestSupport with AnyWordSpecLike {

  "Find A Property Audit Model" should {

    val exampleModel =
      BusinessRatesBillAuditModel(
        "123456",
        BusinessRatesBillForm("Yes"),
